...
if __name__ == '__main__':
    ...
    for identifier in model_identifiers:
        ...
        now = datetime.now()
        log_name = f'training_{identifier}_{now.year}_{now.month}_{now.day}_{now.hour}_{now.minute}_{now.second}_augmented.log'
        model_name = f'model_{identifier}_{now.year}_{now.month}_{now.day}_{now.hour}_{now.minute}_{now.second}_augmented.keras'
